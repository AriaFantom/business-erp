...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    key: 'sales',
    label: 'Sales',
    description: 'Customers and sales orders. Confirming a sale draws stock and issues an invoice.',
    stage: 'sales',
    dependsOn: ['inventory', 'invoices'],
    routePrefixes: ['/sales', '/customers'],
    icon: 'ShoppingCart',
  },
  {
    key: 'invoices',
    label: 'Invoices',
    description: 'Invoices and payments generated from sales.',
    stage: 'sales',
    parent: 'sales',
    dependsOn: [],
  ...
  },
  {
    key: 'quotations',
    label: 'Quotations',
    description: 'Customer quotes that can be converted into sales.',
    stage: 'sales',
    parent: 'sales',
    dependsOn: ['sales'],
  ...
  },
  {
    ...
    stage: 'sales',
    parent: 'sales',
    dependsOn: ['sales', 'inventory', 'invoices'],
    routePrefixes: ['/pos'],
    icon: 'Store',
  },
  {
...
export const PRESETS: ModulePreset[] = [
  {
    key: 'wholesale',
    label: 'Wholesale',
    description: 'Buy and resell: Purchase → Inventory → Sale.',
    modules: ['purchase', 'inventory', 'sales', 'invoices', 'quotations', 'reports'],
  },
  {
    key: 'manufacturer',
    label: 'Manufacturer',
  ...
  },
  {
    ...
    modules: ['inventory', 'sales', 'invoices', 'pos', 'reports'],
  },
]
